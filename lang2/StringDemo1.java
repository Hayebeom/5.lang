...
public class StringDemo1 {
	...
	public static void main(String[] args) {
		...
		// ★ String 클래스의 주요 메서드
		// ★ String은 문자열을 자르거나 변환할 수 없고, 새롭게 문자열을 생성하는 것
		...
		// boolean equals(Object other) : 자신과 other로 전달받은 내용 비교 결과 반환
		// boolean equalsIgnoreCase(String other) : ㄴ 대소문자 구분하지 않음
		...
		// String substring(int begin) : 지정된 위치에서부터 끝까지 포함된 새로운 문자열 반환
		// String substring(int begin, int end) : 지정된 범위내의 문자열이 포함된 새로운 문자열 반환
		// 공백도 포함
		...
		System.out.println();
		System.out.println("8번째부터 끝까지 포함하는 문자열 :" + s1);
		System.out.println("3번째부터 9번째 앞까지 포함하는 문자열 :" + s2);
		
		// String toUpperCase() : 대문자로 변환된 문자열을 생성 후 반환
		// String toLowerCase() : 소문자로 변환된 문자열을 생성 후 반환
		...
		/*
		 String replace(CharSequence old, CharSequence nw)
		  : 문자열에서 지정된 문자열을 새문자열로 변환한 새로운 문자열 반환
		 String replaceAll(String regexp, String replacement)
		  : 문자열에서 지정된 정규표현식과 일치하는 문자열을 찾아서 새 문자열로 변환한 새로운 문자열 반환
		*/
		String str5 = "중앙ABC병원과 새중앙ABC병원은 별도의 법인이다.";
		String s5 = str5.replace("중앙", "현대");
		System.out.println("원본 문자열 : " + str5);
		System.out.println("새 문자열 : " + s5);
		...
		System.out.println();
		// String[] split(String regexp) : 문자열을 지정된 표현식(혹은 구분문자)으로 자른 새로운 문자열 반환
		String str7 = "SOO1,전자공학과,회로이론실습,홍길동,3";
		...
		// boolean contains(CharSequence s) : 문자열이 지정된 문자열이 포함되어 있으면 true 반환
		// int indexOf(String str) : 문자열에 지정된 문자열 있으면 그 위치 반환, 없으면 -1 반환
		// int lassIndexOf(String str) : 지정된 문자열이 마지막으로 등장하는 위치 반환, 없으면 -1 반환
		System.out.println();
		...
		// boolean startWith(String prefix) : 문자열이 지정된 문자열로 시작하면 true 반환
		// boolean endsWith(String suffix) : 문자열이 지정된 문자열로 끝나면 true 반환
		System.out.println();
		...
		/*
		int compartTo(String other)
 		다른 문자열과 사전순서를 기준으로 비교했을 때 같으면 0, 빠르면 음수, 늦으면 양수 반환
 		내림차순, 오름차순 정렬시 사용
		*/
		System.out.println();
		...
		// String trim() : 문자열에서 불필요한 좌우공백을 제거한 새로운 문자열 반환
		// 문자 사이 공백은 제거하지 않음
		...
		// String String.valueOf(다양한 값) : 전달받은 값을 문자열로 변환해서 반한
		System.out.println();
		int num1 = 123456;
		int num2 = 7890;
		String s8 = String.valueOf(num1);
		String s9 = String.valueOf(num2);
		System.out.println(num1 + num2); // ?? 왜 131346이지
